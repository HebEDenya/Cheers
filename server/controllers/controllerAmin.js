...
const getMessages = (req, res) => {
  ...
  console.log(eventid)
  database.query(`SELECT * FROM MESSAGE where event_id = '${eventid}'`)
    .then((result) => {
      if (result.length > 0) {
...
const sendMessage = (req, res) => {
  ...
  database.query(`INSERT INTO MESSAGE (sender_id,receiver_id, event_id,time,text) VALUES ('${senderid}','${receiverid}','${eventid}','${time}','${text}')`)
    .then(() => {
